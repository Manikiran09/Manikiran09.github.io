...
const RegisterPage = () => {
  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-8 md:py-10">
      <section className="grid w-full max-w-6xl overflow-hidden rounded-[2rem] border border-white/50 bg-white/35 shadow-glow backdrop-blur-2xl lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <section className="w-full rounded-none border-0 bg-white/85 p-6 md:p-10 lg:rounded-r-[2rem]">
          <div className="mb-8">
            <p className="text-sm font-bold uppercase tracking-[0.24em] text-teal-700">Create your account</p>
            <h1 className="mt-2 font-display text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">Sign Up</h1>
