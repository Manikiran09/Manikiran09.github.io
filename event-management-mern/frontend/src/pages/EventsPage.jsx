      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6 md:py-10">
        <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 font-display text-3xl font-bold tracking-tight text-slate-950 md:text-5xl">Explore and manage events</h1>
          </div>
        ...
        {isManager ? (
          <section className="mb-8 rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow backdrop-blur-md">
            <div className="mb-6 flex items-center justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-slate-950">Create Event</h2>
        ...
        <section className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
          ...
          {events.map((event) => {
            ...
            return (
              <article key={event._id} className="flex h-full flex-col justify-between rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow backdrop-blur-md">
                <div>
                  ...
                  <h3 className="font-display text-2xl font-bold tracking-tight text-slate-950">{event.title}</h3>
