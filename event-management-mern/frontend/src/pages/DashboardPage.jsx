      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6 md:py-10">
        <section className="overflow-hidden rounded-3xl border border-white/70 bg-white/80 p-0 shadow-glow backdrop-blur-md">
          <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="bg-slate-950 px-6 py-8 text-white md:px-10 md:py-12">
              ...
              <h1 className="mt-5 font-display text-3xl font-bold tracking-tight text-white md:text-5xl">Welcome, {user?.name}</h1>
            ...
            <div className="bg-white/80 px-6 py-8 md:px-10 md:py-12">
