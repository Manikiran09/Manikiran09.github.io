    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6 md:py-10">
        <div className="mb-8 flex flex-col gap-3">
          ...
          <h1 className="font-display text-3xl font-bold tracking-tight text-slate-950 md:text-5xl">My Registrations</h1>
        ...
        <section className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
          {registrations.map((item) => (
            <article className="flex h-full flex-col justify-between rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow backdrop-blur-md" key={item._id}>
              <div>
                ...
                <h3 className="font-display text-2xl font-bold tracking-tight text-slate-950">{item.event?.title}</h3>
