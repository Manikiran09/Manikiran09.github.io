    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6 md:py-10">
        <div className="mb-8 flex flex-col gap-3">
          ...
          <h1 className="font-display text-3xl font-bold tracking-tight text-slate-950 md:text-5xl">User Management</h1>
        ...
        <section className="grid gap-6 xl:grid-cols-2">
          <section className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow backdrop-blur-md">
            <div className="mb-6 flex items-center justify-between gap-4">
              <div>
                <h2 className="font-display text-2xl font-bold tracking-tight text-slate-950">Create Account</h2>
          ...
          {editForm ? (
            <section className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow backdrop-blur-md">
              <div className="mb-6 flex items-center justify-between gap-4">
                <div>
                  <h2 className="font-display text-2xl font-bold tracking-tight text-slate-950">Edit User</h2>
        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-2">
          <section className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow backdrop-blur-md">
          <h2 className="font-display text-2xl font-bold tracking-tight text-slate-950">All Users</h2>
          ...
          <section className="rounded-3xl border border-white/70 bg-white/80 p-6 shadow-glow backdrop-blur-md">
          <h2 className="font-display text-2xl font-bold tracking-tight text-slate-950">Pending Signups</h2>
